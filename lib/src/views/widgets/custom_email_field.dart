...
class CustomEmailTextField extends StatefulWidget {
  ...
  @override
  State<CustomEmailTextField> createState() => _CustomTextFieldState();
}

class _CustomTextFieldState extends State<CustomEmailTextField> {
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: widget.showSuffixIcon
              ...
              child: SvgPicture.asset(LanceVectors.checkIcon, width: 8, height: 8,),
            )
                : null
                : null,
            ...
            focusedBorder: OutlineInputBorder(
              borderSide: BorderSide(
                width: 2.0.w,
                color: LanceColors.textColor..withOpacity(0.9),
              ),
              borderRadius: BorderRadius.circular(10.0.r),
            ),
